...
const LOG_POOL: Omit<LogEntry, 'id' | 'ts'>[] = [
    ...
    { level: 'WARN', message: '[execute] write-back sap_jdt_num falhou (recno=1234)', source: 'execute' },
    ...
    { level: 'INFO', message: '[sync_sap] write-back OK: se2010/recno=881 → sap_jdt_num=5821', source: 'sync' },
